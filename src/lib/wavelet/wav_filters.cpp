...
float D79_FLP[9] = {(float)0.0378287, (float) - 0.0238492, (float) - 0.110624, (float)0.3774026, \
    (float)0.8526986, (float)0.3774026, (float) - 0.110624, (float) - 0.0238492, \
    (float)0.0378287
                   };

float D79_FHP[7] = {(float)0.064539, (float) - 0.0406897, (float) - 0.4180924, (float)0.7884848, \
    (float) - 0.4180924, (float) - 0.0406897, (float)0.064539
                   };

float D79_ILP[7] = {(float) - 0.064539, (float) - 0.0406897, (float)0.4180924, (float)0.7884848, \
    (float)0.4180924, (float) - 0.0406897, (float) - 0.064539
                   };

float D79_IHP[9] = {(float)0.0378287, (float)0.0238492, (float) - 0.110624, (float) - 0.3774026, \
    (float)0.8526986, (float) - 0.3774026, (float) - 0.110624, (float)0.0238492, \
    (float)0.0378287
                   };
