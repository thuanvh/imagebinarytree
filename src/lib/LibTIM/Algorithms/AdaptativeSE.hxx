...
//TODO: ajouter � l'�l�ment structurant uniquement les points ayant une mesure statistique par rapport
//au voisinage (moyenne, �cart-type) proche du point consid�r�.
// Gain: vitesse (pr�calcul)
